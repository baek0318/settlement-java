...
public class QOrderDetail extends EntityPathBase<OrderDetail> {
    ...
    private static final long serialVersionUID = 415458168L;
    ...
    public QOrderDetail(Class<? extends OrderDetail> type, PathMetadata metadata, PathInits inits) {
        ...
        this.orderTable = inits.isInitialized("orderTable") ? new QOrderTable(forProperty("orderTable"), inits.get("orderTable")) : null;
    }
