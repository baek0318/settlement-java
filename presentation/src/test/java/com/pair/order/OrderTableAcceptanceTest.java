...
import com.pair.order.dto.request.OrderDetailSaveRequest;
...
import com.pair.order.dto.response.OrderDetailInfoResponse;
    ...
    void 업주_아이디로_주문검색() {
        ...
        OrderInfoListResponse response =
                given()
                        ...
                        .accept("application/json")
                        .contentType("application/json")
                        .queryParam("com.pair.owner-id", owner.getId())
                .when()
                        .get("/order")
                .thenReturn()
                        .body()
    ...
    void 주문_아이디로_검색() {
        ...
        OrderInfoListResponse response =
                given()
                        ...
                        .accept("application/json")
                        .contentType("application/json")
                        .queryParam("com.pair.order-id", orderTable.getId())
                .when()
                        .get("/order")
                .thenReturn()
                        .body()
